          ...
          <div class="mui-card-content-inner">
            ...
            <div class="info">
              ...
              <p>
                ...
                <!-- 问题：如何从购物车中获取商品的数量呢 -->
                <!-- 1.我们可以先创建一个空对象，然后循环购物车中所有的商品数据，把当前
                循环的这条商品的ID作为对象的属性名，count值作为对象的属性值，这样，当把
                所有的商品循环一遍，就会得到一个对象：{88：2，87：3，90：4}-->
...
export default {
  ...
  methods: {
    getGoodsList() {
      //1.获取到store 中所有商品的ID，然后拼接处一个用逗号分隔的字符串
      var idArr = [];
    ...
    remove(id, index) {
      // 点击删除，把商品从store中根据传递的Id删除，同时把当前组件中的goodlist中，对应要删除的那个商品，使用index来删除
